...
class DayExpenseList extends StatelessWidget {
  const DayExpenseList({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: TransactionDB.instance.dayExpensetransactionListNotifier,
